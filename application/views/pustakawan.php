<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Pustakawan
            <small>Pustakawan Perpustakaan</small>
        </h1>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Pustakawan Perpustakaan</h3>
            ...
            <div class="box-body">
                ...
                <button id="btnAdd" class="btn bg-maroon margin">Tambah Pustakawan</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span></button>
                    <h4 class="modal-title">Konfirmasi Menghapus Pustakawan</h4>
                </div>
                <div class="modal-body">
                ...
                $('tbody').on('click', '.item-delete', function() {
                    ...
                    $('#btnDelete').unbind().click(function() {
                        $.ajax({
                            type: 'ajax',
                            method: 'get',
                            url: "<?= base_url('pustakawan/deletePustakawan') ?>",
                            data: {
                                id_pustakawan: id_pustakawan
                            },
                            dataType: 'json',
