...
<body translate="no">
    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            ...
            <h1>PERL</h1>
            <span>Perpustakaan Online (Anggota)</span>
            <br>
            <?php if ($error = $this->session->flashdata('danger')); ?>
            <code><?= $error; ?></code>
            <input type="text" name="username" id="username" placeholder="Nama Pengguna" autocomplete="off" />
        ...
        <div class="form-container sign-in-container">
            <?= form_open('Auth/pengunjung', 'id="cek"'); ?>
            <img src="<?= base_url('assets/img/LOGO3.jpeg') ?>" height="80px" weight="80px">
            <h1>PERL</h1>
            <span>Perpustakaan Online (Pengunjung)</span>
            <br>
            <input type="text" name="nama" id="nama" placeholder="Nama" autocomplete="off" required />
            <input type="number" name="hp" id="hp" placeholder="Nomor Hp." autocomplete="off" required />
            <br>
            <button>Masuk</button>
            <?= form_close(); ?>
        </div>
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    ...
                    <button class="ghost" id="signIn">Masuk Sebagai Pengunjung</button>
                </div>
                <div class="overlay-panel overlay-right">
                    <h1>Selamat Datang!</h1>
                    <p>Di Buku Tamu Perpustakaan Online Balai Bahasa Sulawesi Tengah</p>
                    <button class="ghost" id="signUp">Masuk Sebagai Anggota</button>
                </div>
            </div>
        </div>
    </div>
